                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="p-4">
                            <input name="name" className="form-control w-100" placeholder="Your Name" ref={register({ required: true })} />
                            {errors.name && <span><p>This field is required</p></span>}

                            <input name="company" className="form-control mt-3 w-100" placeholder="Designation, Company Name" ref={register({ required: true })} />
                            {errors.company && <span><p>This field is required</p></span>}

                            <textarea rows="3" name="description" className="form-control mt-3 w-100" placeholder="Description" ref={register({ required: true })} />
